...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        // 按时间，滚动窗口，process 方法
        wordGroups.window(TumblingProcessingTimeWindows.of(Duration.ofSeconds(10))).process(new ProcessWindowFunction<Tuple2<String, Integer>, Tuple1<String>, String, TimeWindow>() {
            @Override
